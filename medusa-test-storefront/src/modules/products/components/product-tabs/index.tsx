        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Votre colis arrivera dans 3-5 jours ouvrés à votre point de retrait ou directement chez vous.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              La taille ne convient pas ? Aucun souci - nous échangerons votre produit contre un nouveau.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Retournez simplement votre produit et nous vous rembourserons. Sans questions - nous ferons de notre mieux pour que votre retour soit sans tracas.
            </p>
          </div>
        </div>
      </div>
